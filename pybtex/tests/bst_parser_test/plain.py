...
bst = [   u'entry',
    ([Identifier(u'address'), Identifier(u'author'), Identifier(u'booktitle'), Identifier(u'chapter'), Identifier(u'edition'), Identifier(u'editor'), Identifier(u'howpublished'), Identifier(u'institution'), Identifier(u'journal'), Identifier(u'key'), Identifier(u'month'), Identifier(u'note'), Identifier(u'number'), Identifier(u'organization'), Identifier(u'pages'), Identifier(u'publisher'), Identifier(u'school'), Identifier(u'series'), Identifier(u'title'), Identifier(u'type'), Identifier(u'volume'), Identifier(u'year')], {}),
    ([], {}),
    ([Identifier(u'label')], {}),
    u'integers',
    ([Identifier(u'output.state'), Identifier(u'before.all'), Identifier(u'mid.sentence'), Identifier(u'after.sentence'), Identifier(u'after.block')], {}),
    u'function',
    ([Identifier(u'init.state.consts')], {}),
    ([Integer(0), QuotedVar(u'before.all'), Identifier(u':='), Integer(1), QuotedVar(u'mid.sentence'), Identifier(u':='), Integer(2), QuotedVar(u'after.sentence'), Identifier(u':='), Integer(3), QuotedVar(u'after.block'), Identifier(u':=')], {}),
    u'strings',
    ([Identifier(u's'), Identifier(u't')], {}),
    u'function',
    ([Identifier(u'output.nonnull')], {}),
    ([QuotedVar(u's'), Identifier(u':='), Identifier(u'output.state'), Identifier(u'mid.sentence'), Identifier(u'='), FunctionLiteral(([String(u', '), Identifier(u'*'), Identifier(u'write$')], {})), FunctionLiteral(([Identifier(u'output.state'), Identifier(u'after.block'), Identifier(u'='), FunctionLiteral(([Identifier(u'add.period$'), Identifier(u'write$'), Identifier(u'newline$'), String(u'\\newblock '), Identifier(u'write$')], {})), FunctionLiteral(([Identifier(u'output.state'), Identifier(u'before.all'), Identifier(u'='), QuotedVar(u'write$'), FunctionLiteral(([Identifier(u'add.period$'), String(u' '), Identifier(u'*'), Identifier(u'write$')], {})), Identifier(u'if$')], {})), Identifier(u'if$'), Identifier(u'mid.sentence'), QuotedVar(u'output.state'), Identifier(u':=')], {})), Identifier(u'if$'), Identifier(u's')], {}),
    u'function',
    ([Identifier(u'output')], {}),
    ([Identifier(u'duplicate$'), Identifier(u'empty$'), QuotedVar(u'pop$'), QuotedVar(u'output.nonnull'), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'output.check')], {}),
    ([QuotedVar(u't'), Identifier(u':='), Identifier(u'duplicate$'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'pop$'), String(u'empty '), Identifier(u't'), Identifier(u'*'), String(u' in '), Identifier(u'*'), Identifier(u'cite$'), Identifier(u'*'), Identifier(u'warning$')], {})), QuotedVar(u'output.nonnull'), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'output.bibitem')], {}),
    ([Identifier(u'newline$'), String(u'\\bibitem{'), Identifier(u'write$'), Identifier(u'cite$'), Identifier(u'write$'), String(u'}'), Identifier(u'write$'), Identifier(u'newline$'), String(u''), Identifier(u'before.all'), QuotedVar(u'output.state'), Identifier(u':=')], {}),
    u'function',
    ([Identifier(u'fin.entry')], {}),
    ([Identifier(u'add.period$'), Identifier(u'write$'), Identifier(u'newline$')], {}),
    u'function',
    ([Identifier(u'new.block')], {}),
    ([Identifier(u'output.state'), Identifier(u'before.all'), Identifier(u'='), QuotedVar(u'skip$'), FunctionLiteral(([Identifier(u'after.block'), QuotedVar(u'output.state'), Identifier(u':=')], {})), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'new.sentence')], {}),
    ([Identifier(u'output.state'), Identifier(u'after.block'), Identifier(u'='), QuotedVar(u'skip$'), FunctionLiteral(([Identifier(u'output.state'), Identifier(u'before.all'), Identifier(u'='), QuotedVar(u'skip$'), FunctionLiteral(([Identifier(u'after.sentence'), QuotedVar(u'output.state'), Identifier(u':=')], {})), Identifier(u'if$')], {})), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'not')], {}),
    ...
    ([Identifier(u'output.bibitem'), Identifier(u'format.authors'), String(u'author'), Identifier(u'output.check'), Identifier(u'new.block'), Identifier(u'format.title'), String(u'title'), Identifier(u'output.check'), Identifier(u'new.block'), Identifier(u'note'), String(u'note'), Identifier(u'output.check'), Identifier(u'format.date'), Identifier(u'output'), Identifier(u'fin.entry')], {}),
    u'function',
    ...
    u'macro',
    ([Identifier(u'acmcs')], {}),
    ([String(u'ACM Computing Surveys')], {}),
    u'macro',
    ([Identifier(u'acta')], {}),
    ([String(u'Acta Informatica')], {}),
    u'macro',
    ([Identifier(u'cacm')], {}),
    ([String(u'Communications of the ACM')], {}),
    u'macro',
    ([Identifier(u'ibmjrd')], {}),
    ([String(u'IBM Journal of Research and Development')], {}),
    u'macro',
    ([Identifier(u'ibmsj')], {}),
    ([String(u'IBM Systems Journal')], {}),
    u'macro',
    ([Identifier(u'ieeese')], {}),
    ...
    u'macro',
    ([Identifier(u'ipl')], {}),
    ([String(u'Information Processing Letters')], {}),
    u'macro',
    ([Identifier(u'jacm')], {}),
    ([String(u'Journal of the ACM')], {}),
    u'macro',
    ([Identifier(u'jcss')], {}),
    ...
    u'macro',
    ([Identifier(u'sicomp')], {}),
    ([String(u'SIAM Journal on Computing')], {}),
    u'macro',
    ([Identifier(u'tocs')], {}),
    ...
    u'macro',
    ([Identifier(u'tog')], {}),
    ([String(u'ACM Transactions on Graphics')], {}),
    u'macro',
    ([Identifier(u'toms')], {}),
    ...
    u'macro',
    ([Identifier(u'tcs')], {}),
    ([String(u'Theoretical Computer Science')], {}),
    u'read',
    u'function',
    ...
    ([QuotedVar(u's'), Identifier(u':='), QuotedVar(u'len'), Identifier(u':='), Identifier(u's'), Integer(1), Identifier(u'len'), Identifier(u'substring$'), Identifier(u'='), FunctionLiteral(([Identifier(u's'), Identifier(u'len'), Integer(1), Identifier(u'+'), Identifier(u'global.max$'), Identifier(u'substring$')], {})), QuotedVar(u's'), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'sort.format.names')], {}),
    ([QuotedVar(u's'), Identifier(u':='), Integer(1), QuotedVar(u'nameptr'), Identifier(u':='), String(u''), Identifier(u's'), Identifier(u'num.names$'), QuotedVar(u'numnames'), Identifier(u':='), Identifier(u'numnames'), QuotedVar(u'namesleft'), Identifier(u':='), FunctionLiteral(([Identifier(u'namesleft'), Integer(0), Identifier(u'>')], {})), FunctionLiteral(([Identifier(u'nameptr'), Integer(1), Identifier(u'>'), FunctionLiteral(([String(u'   '), Identifier(u'*')], {})), QuotedVar(u'skip$'), Identifier(u'if$'), Identifier(u's'), Identifier(u'nameptr'), String(u'{vv{ } }{ll{ }}{  ff{ }}{  jj{ }}'), Identifier(u'format.name$'), QuotedVar(u't'), Identifier(u':='), Identifier(u'nameptr'), Identifier(u'numnames'), Identifier(u'='), Identifier(u't'), String(u'others'), Identifier(u'='), Identifier(u'and'), FunctionLiteral(([String(u'et al'), Identifier(u'*')], {})), FunctionLiteral(([Identifier(u't'), Identifier(u'sortify'), Identifier(u'*')], {})), Identifier(u'if$'), Identifier(u'nameptr'), Integer(1), Identifier(u'+'), QuotedVar(u'nameptr'), Identifier(u':='), Identifier(u'namesleft'), Integer(1), Identifier(u'-'), QuotedVar(u'namesleft'), Identifier(u':=')], {})), Identifier(u'while$')], {}),
    u'function',
    ([Identifier(u'sort.format.title')], {}),
    ([QuotedVar(u't'), Identifier(u':='), String(u'A '), Integer(2), String(u'An '), Integer(3), String(u'The '), Integer(4), Identifier(u't'), Identifier(u'chop.word'), Identifier(u'chop.word'), Identifier(u'chop.word'), Identifier(u'sortify'), Integer(1), Identifier(u'global.max$'), Identifier(u'substring$')], {}),
    u'function',
    ([Identifier(u'author.sort')], {}),
    ([Identifier(u'author'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'key'), Identifier(u'empty$'), FunctionLiteral(([String(u'to sort, need author or key in '), Identifier(u'cite$'), Identifier(u'*'), Identifier(u'warning$'), String(u'')], {})), FunctionLiteral(([Identifier(u'key'), Identifier(u'sortify')], {})), Identifier(u'if$')], {})), FunctionLiteral(([Identifier(u'author'), Identifier(u'sort.format.names')], {})), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'author.editor.sort')], {}),
    ([Identifier(u'author'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'editor'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'key'), Identifier(u'empty$'), FunctionLiteral(([String(u'to sort, need author, editor, or key in '), Identifier(u'cite$'), Identifier(u'*'), Identifier(u'warning$'), String(u'')], {})), FunctionLiteral(([Identifier(u'key'), Identifier(u'sortify')], {})), Identifier(u'if$')], {})), FunctionLiteral(([Identifier(u'editor'), Identifier(u'sort.format.names')], {})), Identifier(u'if$')], {})), FunctionLiteral(([Identifier(u'author'), Identifier(u'sort.format.names')], {})), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'author.organization.sort')], {}),
    ([Identifier(u'author'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'organization'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'key'), Identifier(u'empty$'), FunctionLiteral(([String(u'to sort, need author, organization, or key in '), Identifier(u'cite$'), Identifier(u'*'), Identifier(u'warning$'), String(u'')], {})), FunctionLiteral(([Identifier(u'key'), Identifier(u'sortify')], {})), Identifier(u'if$')], {})), FunctionLiteral(([String(u'The '), Integer(4), Identifier(u'organization'), Identifier(u'chop.word'), Identifier(u'sortify')], {})), Identifier(u'if$')], {})), FunctionLiteral(([Identifier(u'author'), Identifier(u'sort.format.names')], {})), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'editor.organization.sort')], {}),
    ([Identifier(u'editor'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'organization'), Identifier(u'empty$'), FunctionLiteral(([Identifier(u'key'), Identifier(u'empty$'), FunctionLiteral(([String(u'to sort, need editor, organization, or key in '), Identifier(u'cite$'), Identifier(u'*'), Identifier(u'warning$'), String(u'')], {})), FunctionLiteral(([Identifier(u'key'), Identifier(u'sortify')], {})), Identifier(u'if$')], {})), FunctionLiteral(([String(u'The '), Integer(4), Identifier(u'organization'), Identifier(u'chop.word'), Identifier(u'sortify')], {})), Identifier(u'if$')], {})), FunctionLiteral(([Identifier(u'editor'), Identifier(u'sort.format.names')], {})), Identifier(u'if$')], {}),
    u'function',
    ([Identifier(u'presort')], {}),
    ([Identifier(u'type$'), String(u'book'), Identifier(u'='), Identifier(u'type$'), String(u'inbook'), Identifier(u'='), Identifier(u'or'), QuotedVar(u'author.editor.sort'), FunctionLiteral(([Identifier(u'type$'), String(u'proceedings'), Identifier(u'='), QuotedVar(u'editor.organization.sort'), FunctionLiteral(([Identifier(u'type$'), String(u'manual'), Identifier(u'='), QuotedVar(u'author.organization.sort'), QuotedVar(u'author.sort'), Identifier(u'if$')], {})), Identifier(u'if$')], {})), Identifier(u'if$'), String(u'    '), Identifier(u'*'), Identifier(u'year'), Identifier(u'field.or.null'), Identifier(u'sortify'), Identifier(u'*'), String(u'    '), Identifier(u'*'), Identifier(u'title'), Identifier(u'field.or.null'), Identifier(u'sort.format.title'), Identifier(u'*'), Integer(1), Identifier(u'entry.max$'), Identifier(u'substring$'), QuotedVar(u'sort.key$'), Identifier(u':=')], {}),
    u'iterate',
    ([Identifier(u'presort')], {}),
    u'sort',
    u'strings',
    ...
    ([String(u''), QuotedVar(u'longest.label'), Identifier(u':='), Integer(1), QuotedVar(u'number.label'), Identifier(u':='), Integer(0), QuotedVar(u'longest.label.width'), Identifier(u':=')], {}),
    u'function',
    ([Identifier(u'longest.label.pass')], {}),
    ([Identifier(u'number.label'), Identifier(u'int.to.str$'), QuotedVar(u'label'), Identifier(u':='), Identifier(u'number.label'), Integer(1), Identifier(u'+'), QuotedVar(u'number.label'), Identifier(u':='), Identifier(u'label'), Identifier(u'width$'), Identifier(u'longest.label.width'), Identifier(u'>'), FunctionLiteral(([Identifier(u'label'), QuotedVar(u'longest.label'), Identifier(u':='), Identifier(u'label'), Identifier(u'width$'), QuotedVar(u'longest.label.width'), Identifier(u':=')], {})), QuotedVar(u'skip$'), Identifier(u'if$')], {}),
    u'execute',
    ([Identifier(u'initialize.longest.label')], {}),
    u'iterate',
    ([Identifier(u'longest.label.pass')], {}),
    ...
    ([Identifier(u'preamble$'), Identifier(u'empty$'), QuotedVar(u'skip$'), FunctionLiteral(([Identifier(u'preamble$'), Identifier(u'write$'), Identifier(u'newline$')], {})), Identifier(u'if$'), String(u'\\begin{thebibliography}{'), Identifier(u'longest.label'), Identifier(u'*'), String(u'}'), Identifier(u'*'), Identifier(u'write$'), Identifier(u'newline$')], {}),
    u'execute',
    ([Identifier(u'begin.bib')], {}),
    u'execute',
    ([Identifier(u'init.state.consts')], {}),
    u'iterate',
    ([Identifier(u'call.type$')], {}),
    u'function',
